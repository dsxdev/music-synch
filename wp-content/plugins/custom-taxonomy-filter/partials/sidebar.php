...
<div id="postbox-container-1" class="postbox-container">
    <div class="meta-box-sortables">
		<div class="postbox">
			<h3><?php esc_html_e( 'Help & Supports', 'customtaxfilterinadmin' ) ?></h3>
			<div class="inside">
				<p>Support: <a href="https://codeboxr.com/contact-us" target="_blank"><span class="dashicons dashicons-external"></span> Contact Us</a></p>
				<p><span class="dashicons dashicons-editor-help"></span> <a href="https://codeboxr.com/product/custom-taxonomy-filter-in-wordpress-admin-post-listing/" target="_blank">Plugin Documentation</a></p>
				<p><span class="dashicons dashicons-email"></span> <a href="mailto:info@codeboxr.com">info@codeboxr.com</a></p>
				<p><span class="dashicons dashicons-star-half"></span> <a href="https://wordpress.org/support/plugin/custom-taxonomy-filter/reviews/#new-post" target="_blank">Review This Plugin</a></p>
			</div>
		</div>
		<div class="postbox">
			<h3><?php esc_html_e( 'Other WordPress Plugins', 'customtaxfilterinadmin' ); ?></h3>
			<div class="inside">
			    <?php
		...
		<div class="postbox">
			<h3><?php esc_html_e( 'Codeboxr News Updates', 'customtaxfilterinadmin' ) ?></h3>
			<div class="inside">
			    <?php
